...
- [x] Extract embedded movement-window leads from protocol 03 selector payloads.
  - Current generated report finds 355 embedded movement windows across 37 outer selectors after adjacent wrappers and movement-state tails are bounded. The remaining grouped leads are mostly primary-wrapper variants and larger unclassified tails that still need body-length evidence.
